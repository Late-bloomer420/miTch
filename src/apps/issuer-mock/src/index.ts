...
app.post('/credential', async (req, res) => {
  ...
  const { credential_definition: _credential_definition, proof: _proof } =
    req.body as CredentialRequest; // Simplified request parsing
  ...
  const vcPayload: Omit<AgeCredential, 'proof'> = {
    '@context': ['https://www.w3.org/2018/credentials/v1', 'https://mitch.example/contexts/age/v1'],
