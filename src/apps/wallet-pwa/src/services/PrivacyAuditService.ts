  ...
  static async auditTransaction(verifierName: string): Promise<PrivacyContext> {
    ...
    if (userAgent.includes('Android')) {
      trackers.push({
        ...
        dataExposed: [
          {
            field: 'Advertising ID',
            visibility: 'PLAINTEXT',
            linkable: true,
            persistence: 'DEVICE',
          },
          {
            field: 'App Usage Stats',
        ...
        mitigations: [
          {
            type: 'DEGOOGLED',
            label: 'Switch to GrapheneOS',
            effectiveness: 100,
            cost: 'HIGH_EFFORT',
            implementation: { link: 'https://grapheneos.org' },
          },
        ],
      });
        ...
        mitigations: [
          {
            ...
            effectiveness: 90,
            cost: 'FREE',
            implementation: { link: 'https://mozilla.org' },
          },
        ],
      });
    }
    ...
    trackers.push({
      ...
      dataExposed: [
        {
          field: 'DNS Request (Verifier Domain)',
          visibility: 'PLAINTEXT',
          linkable: false,
          persistence: 'SESSION',
        },
      ...
      mitigations: [
        {
          ...
          effectiveness: 95,
          cost: 'PAID',
          implementation: { automaticOption: true, link: 'https://mullvad.net' },
        },
      ],
    });
    ...
    const overallScore = Math.max(
      ...
      100 -
        trackers.reduce(
          (sum, t) => sum + (t.riskLevel === 'HIGH' ? 40 : t.riskLevel === 'MEDIUM' ? 20 : 5),
          0
        )
    );
