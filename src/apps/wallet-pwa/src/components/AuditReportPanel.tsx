...
export const ComplianceDashboard: React.FC<ComplianceDashboardProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <h3 style={{ margin: 0, fontSize: '20px', fontWeight: '800' }}>🛡️ Compliance Center</h3>
        <div
          style={{
            display: 'flex',
            alignItems: 'center',
        ...
        >
          <span
            className="pulse-dot"
            style={{ background: isChainValid ? '#10b981' : '#f87171' }}
          ></span>
      ...
      <div className="recent-log-list" style={{ marginBottom: '25px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
          {recentLogs.length === 0 && (
            <div style={{ color: '#4b5563', fontStyle: 'italic', fontSize: '13px' }}>
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: '11px', color: '#6b7280' }}>
                  {entry.subjectId
                    ? `Subject: ${entry.subjectId.substring(0, 12)}...`
                    : 'System Operation'}
                </div>
              </div>
              {entry.signature && (
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
        <button
          ...
          style={{
            ...
            borderRadius: '16px',
            border: 'none',
            background: isChainValid ? 'linear-gradient(to right, #6366f1, #a855f7)' : '#4b5563',
            color: 'white',
            fontWeight: '700',
            cursor: 'pointer',
          ...
          <button
            onClick={async () => {
              ...
              try {
                ...
                setStatus(
                  `✅ L2 Anchor Successful: ${receipt.l2TransactionId.substring(0, 10)}...`
                );
              } catch (e: unknown) {
        ...
        >
          Supports GDPR-style data portability and provides cryptographic accountability evidence of
          data minimization and crypto-shredding compliance.
        </p>
      </div>
