  ...
  return (
    ...
    >
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            ...
            <div style={{ fontSize: '11px', color: '#6b7280' }}>
              Only respond to verifiers matched by your rules.
            </div>
          </div>
          <button
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            <div style={{ fontWeight: '600', fontSize: '14px', color: '#fca5a5' }}>
              Deny Secondary Use (EHDS)
            </div>
            <div style={{ fontSize: '11px', color: '#6b7280' }}>
              Global Opt-Out for research, statistics, and policy assessments.
            </div>
          </div>
          <button
            onClick={() => {
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            <div style={{ fontWeight: '600', fontSize: '14px', color: '#fcd34d' }}>
              Third-Country Block (Non-EU)
            </div>
            <div style={{ fontSize: '11px', color: '#6b7280' }}>
              Deny secondary use data export to countries outside the EU/EEA.
            </div>
          </div>
          <button
            onClick={() => {
            ...
            style={{
              ...
              height: '24px',
              borderRadius: '12px',
              background: (policy.globalSettings?.denySecondaryUseCountries || []).includes('*')
                ? '#f59e0b'
                : '#374151',
              border: 'none',
              position: 'relative',
          ...
          >
            <div
              style={{
                ...
                position: 'absolute',
                top: '3px',
                left: (policy.globalSettings?.denySecondaryUseCountries || []).includes('*')
                  ? '23px'
                  : '3px',
                transition: 'left 0.2s',
              }}
        ...
        <div>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
            <div>
              ...
              <div style={{ fontSize: '11px', color: '#6b7280' }}>
                How long Face ID/Touch ID remains valid before asking again.
              </div>
            </div>
            <div style={{ fontSize: '14px', fontWeight: 'bold', color: '#60a5fa' }}>
              {policy.globalSettings?.requireConsentTimeoutMinutes === 0
                ? 'Always ask'
