...
const LABEL_MAP: Record<AuditEventType, { label: string; category: DataFlowEvent['category'] }> = {
  ...
  IDENTITY_ACCESS_DETECTED: { label: 'Identifier-Zugriff erkannt', category: 'identity' },
  ERASURE_REQUESTED: { label: 'Datenlöschung angefordert', category: 'consent' },
  REPORT_SENT: { label: 'Verifier gemeldet', category: 'consent' },
