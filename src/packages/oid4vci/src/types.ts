...
export const CredentialRequestSchema = z.object({
  ...
  claims: z.object({
    name: z.string().describe('Art. 6(1)(b) - Required for identity binding'),
    ...
    residency: z.string().length(2).describe('Art. 6(1)(b) - Required for jurisdiction check'),
  }),
...
export const CredentialResponseSchema = z.object({
  credential: z.string().describe('JWS/JWT signed Verifiable Credential'),
