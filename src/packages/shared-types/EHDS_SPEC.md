...
- **Emergency Access**: If `verifier_type == "EMERGENCY_ER"`, allow access _without_ immediate consent but trigger a high-priority Audit Alert ("Break-Glass Event") + notify user.
