...
function fromBase64(b64: string): Uint8Array {
  try {
    ...
    throw new Error(
      `Base64 decoding failed: ${e instanceof Error ? e.message : 'Invalid characters'}`
    );
  }
}
 ...
 */
export async function decrypt(data: string, key: CryptoKey, aad?: BufferSource): Promise<string> {
