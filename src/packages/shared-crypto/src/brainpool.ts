 ...
 * - brainpoolP512r1 (512-bit, RFC 5639 §3.7)
 *
...
// ─── brainpoolP512r1 Parameters (RFC 5639 §3.7) ─────────────────────────────
...
const bp512Point = weierstrass(BP512_CURVE);
const bp512ECDSA = ecdsa(bp512Point, sha512);

// ─── Curve Dispatch ──────────────────────────────────────────────────────────

function getEcdsa(curve: BrainpoolCurve) {
    switch (curve) {
        case 'brainpoolP256r1': return bp256ECDSA;
        case 'brainpoolP384r1': return bp384ECDSA;
        case 'brainpoolP512r1': return bp512ECDSA;
    }
}

function getCoordLength(curve: BrainpoolCurve): number {
    switch (curve) {
        case 'brainpoolP256r1': return 32;
        case 'brainpoolP384r1': return 48;
        case 'brainpoolP512r1': return 64;
    }
}

// ─── Public Types ─────────────────────────────────────────────────────────────

export type BrainpoolCurve = 'brainpoolP256r1' | 'brainpoolP384r1' | 'brainpoolP512r1';
