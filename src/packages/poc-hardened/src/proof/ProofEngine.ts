...
export class ProofEngine {
   ...
   */
  public generateProof(decision: ConsentDecision, userId: string, category: string): Proof {
    const proof: Proof = {
   ...
   */
  private validateAndAbstract(category: string, rawData: any, proof: Proof): boolean {
    switch (category) {
      case 'age':
