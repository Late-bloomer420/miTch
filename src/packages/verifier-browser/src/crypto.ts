 ...
 */
export async function decryptJWE(jwe: string, privateKey: CryptoKey): Promise<string> {
  ...
  const zBuf = await crypto.subtle.deriveBits({ name: 'ECDH', public: epk }, ecdhPrivKey, 256);
