...
import { DecisionProofPayload, PredicateEvaluation, PredicateResult } from './types';
  ...
  if (clause.op === 'exists') {
    ...
    if (shouldExist) {
      return {
        ...
        reasonCode: value !== undefined ? undefined : 'MISSING_PATH',
      };
    } else {
      return {
        passed: value === undefined,
        reasonCode: value === undefined ? undefined : 'CRITERIA_NOT_MET',
      };
    }
  }
