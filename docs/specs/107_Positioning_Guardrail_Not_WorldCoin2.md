# 107 — Positioning Guardrail: Not WorldCoin2

Stand: 2026-02-12
Purpose: prevent narrative drift that damages trust and adoption.
...
Even if technology differs, perception can block procurement and pilot approvals.
...
- "Minimal disclosure, auditable outcomes"
...
4. We preserve accountability while minimizing disclosure.
...
- Explicit assurance-tier communication (software vs hardware-backed)
