...
- The audit-log package (@askmi/audit-log) provides the backend for the daily review — WORM append-only log with integrity chain and L2 anchoring. The UX layer (frontend) is not yet built.
