...
Wir sind kein Identitätsprovider, sondern die Infrastruktur für _verantwortliches Dateneigentum_ und _automatisches Vergessen_.
...
- **Business Question (Sweat this!):** Wer zahlt dafür?
  - _Hypothese A:_ Der **Nutzer** (für Souveränität)? (Unwahrscheinlich im Massenmarkt)
  - _Hypothese B:_ Die **Diensteanbieter** (Risk Reduction & Compliance Costs)? (**Empfohlen**)
  - _Hypothese C:_ **Öffentliche Hand** (als Infrastruktur)?
