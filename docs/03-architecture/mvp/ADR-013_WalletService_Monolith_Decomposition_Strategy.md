...
**Decision:** Modularize and decompose the monolithic `WalletService.ts` into single-responsibility services under `@mitch/wallet-core` and dedicated monorepo packages.
