...
**Stand:** 2026-05-16 (E-11 Offline Verification complete)
...
| E-11 | 🟡 | ISO/IEC 18013-5 (mdoc) Support — mobiler Führerschein — `@mitch/mdoc` Package: CBOR Codec, COSE Sign1 ES256, ISO-18013-5-Typen, MSO Digest Verification, DeviceAuth (Sign1), **vollständige Offline-Verifikation** (`verifyMdocOffline()` — 5-Step Pipeline: Issuer Auth, MSO Digests, Validity, DocType, Device Auth), x5chain Cert-Extraktion + SPKI-Parser, DeviceResponse Parser — 134 tests; offen: Wallet-/Verifier-Integration, Hybrid Issuance, COSE_Mac0 | ISO.18013-5 |
...
| ADR-012 | ISO 18013-5 mdoc & Offline Verification | PROPOSED | dokumentiert; E-11 Offline-Verifikation implementiert (134 tests), Wallet-/Verifier-Integration offen |
