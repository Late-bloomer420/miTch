...
**Update 2026-06-21 (G-140 Layer-2 PR1 + Merges):** master jetzt `1d0264d`/**PR #112**. Gemerged seit H-10: #110 (H-10 docs), #109 (EU-boundaries/Layer-2 Fundament 08/09 + Entsch. 1&2), #108 (dependabot), #106 (4-Fenster-Launcher konsolidiert), **#112 (G-140 Layer-2 PR1)**. PR1 = `WalletService.evaluateRequest()` loggt ein neutrales, PII-minimales `POLICY_EVALUATED`-Event auf JEDEM Verdict (requested_claims roh inkl. Over-Ask, authorized, denied = requested−authorized, verdict, reason_codes; neuer Typ `DisclosureDecisionMetadata`). **WICHTIG — G-140.1 bleibt ⏳:** PR1 ist nur das Logging-Substrat; die nutzerseitige requested/allowed/withheld-*Anzeige* (G-140.1) ist NICHT erledigt — kommt in PR2–PR4 (`docs/_core/09_LAYER2_VISIBILITY_PLAN.md`). Noch offen/PRs: #111 (dependabot vite), #105 (wallet public-preview, exposure — hold).
