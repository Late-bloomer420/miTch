...
- **Convenor-Rolle:** miTch definiert und erzwingt das Regelwerk (Policy Manifest) für ein Ökosystem. Vertrauen entsteht, weil das System strukturell nichts wissen _kann_.
...
- **miTch (Convener):** Stellt die Protokoll-Schienen und Policies.
  ...
  - _Sieht: Metadaten für Audit (Wer, Wann, Was-Typ), aber NIEMALS den Inhalt._
